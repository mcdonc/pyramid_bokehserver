(function() {
  ...
  define(["jquery", "underscore", "common/collection", "common/continuum_view", "common/has_parent", "common/logging"], function($, _, Collection, ContinuumView, HasParent, Logging) {
