(function() {
  ...
  define(["common/collection", "common/build_views", "common/continuum_view", "common/has_parent", "common/logging", "./text_input_template"], function(Collection, build_views, ContinuumView, HasParent, Logging, template) {
